...
![](img/e402af4dcdaa8488d9e8a53e5f3aa1cb.png)
...
在第 4 行和第 5 行中，两个 CSV 都被导入到一个 panda 数据框架中，其中欧元兑美元汇率数据框架的列以“`_USD`”为后缀。两个 CSV 都有一些相同的列名，我们需要能够区分它们。这些数据帧在日期列上合并。
...
![](img/e2abdf98435b8bae2d11d1de9ea5dd53.png)
