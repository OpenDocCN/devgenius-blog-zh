...
> 原文：<https://blog.devgenius.io/how-to-find-number-of-distinct-islands-fa31e5d122f0?source=collection_archive---------3----------------------->

## 第 50 天——100 天去 LinkedIn、雅虎、甲骨文

![](img/62a6ac53fbf47b59c4b6cf9d2a7214b2.png)

由[马雷克·奥孔](https://unsplash.com/@marekokon?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)在 [Unsplash](https://unsplash.com/s/photos/island?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) 上拍摄的照片

*   出于免费的故事？下面是我的 [**好友链接。**](https://akshay-ravindran.medium.com/fa31e5d122f0?source=friends_link&sk=26644d15a0532ee914fe4793f62d9034)
*   100 天到 LinkedIn，雅虎，甲骨文

# 介绍

嘿，伙计们，今天是 LinkedIn 挑战 100 天的第 50 天。
...
数一数**个不同的**个岛屿。当且仅当一个岛可以平移(而不是旋转或反射)到与另一个岛相等时，该岛才被视为与另一个岛相同。
...
1.  如果你知道一个岛的方向，那么镜子将是同样的排列。
2.  创建一个集合，存储岛屿的方向。
3.  遍历网格，在每个索引处检查单元是否为 1，这表示岛的一部分。对于每个 1，在深度优先搜索中遍历，以便可以在集合中存储方向。
4.  在遍历结束时，返回岛的集合🔚
