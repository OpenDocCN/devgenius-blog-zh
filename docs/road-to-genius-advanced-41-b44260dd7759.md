...
> 原文：<https://blog.devgenius.io/road-to-genius-advanced-41-b44260dd7759?source=collection_archive---------26----------------------->

![](img/3276d8af7fdbf48c3e2f2118f2e7688f.png)
...
![](img/5361818cd7809fd54836a319568b57b7.png)

通过解决这些挑战，你可以训练自己成为一名更好的程序员。您将学到更新更好的分析、调试和改进代码的方法。因此，你在商业上会更有效率和价值。从今天开始，在 https://nevolin.be/codr/成为一名认证的 Codr