...
但是在计算机芯片上，没有单独的符号可以用作减号，它都是 0 和 1。
...
更有可能的情况是，芯片将减数乘以 1，然后与被减数相加。说到底，减法只是反过来的加法。
...
对于十六进制，很容易理解 1 是带符号字节中的 FF，FFFF 是“字”，FFFF·FFFF 是“双字”，FFFF·FFFF·FFFF·FFFF 是“四字”
