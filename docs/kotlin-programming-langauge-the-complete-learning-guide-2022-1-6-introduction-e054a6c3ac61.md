...
只需一个脚本就可以将 Java 文件转换成 Kotlin 文件。
...
Kotlin Multi-platform Mobile 是一个用于创建跨平台移动应用程序的软件开发工具包。这意味着，从一个 Kotlin 代码库，你将能够编译应用程序，不仅可以在 Android 手机上运行，也可以在 iPhones 和 Apple Watch 上运行。这个项目目前还处于初级阶段，但前景看好。
